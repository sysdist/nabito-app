...
ActiveRecord::Schema.define(version: 20170605093604) do
  ...
  create_table "relays", force: :cascade do |t|
    ...
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
    t.index ["el_socket_id"], name: "index_relays_on_el_socket_id", using: :btree
  end
  ...
  create_table "socket_monitors", force: :cascade do |t|
    t.integer  "el_socket_id"
    t.integer  "current_sensor_id"
    t.integer  "voltage_sensor_id"
    t.integer  "nominal_voltage"
    t.boolean  "active"
    t.integer  "frequency"
    t.datetime "created_at",        null: false
    t.datetime "updated_at",        null: false
    t.index ["el_socket_id"], name: "index_socket_monitors_on_el_socket_id", using: :btree
  end
  ...
  add_foreign_key "relays", "el_sockets"
  add_foreign_key "socket_loads", "el_sockets"
  add_foreign_key "socket_monitors", "el_sockets"
